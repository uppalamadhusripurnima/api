...
app.put('/api/student/:id',(req,resp)=>{
    ...
    const studentToBeReplaced=studentsList.findIndex(student=> student.id=== idToBeReplaced);
    studentsList[studentToBeReplaced].name=req.body.name;
    studentsList[studentToBeReplaced].age=req.body.age;
    studentsList[studentToBeReplaced].dept=req.body.dept;
    resp.json(studentsList);
})
